...
#include "Socket/Includes/clientSocket.class.hpp"
...
: Socket(blocServer, event), _request(*this), _connection("keep-alive") {}

clientSocket::~clientSocket() {}

clientSocket::clientSocket(const clientSocket& other) : Socket(other), _request(other._request), _connection("keep-alive") {}
