...
/**
 * Constructor of 11-Poll class
 *
 * 11-Poll(const vector<11-Poll> & socket);
 *
 * @param   void
 * @throw   none
 **/
...
/**
 * Copy constructor of 11-Poll class
 *
 * 11-Poll(11-Poll &);
 *
 * @param   other instance to build the 11-Poll
 * @throw   none
 **/
    Epoll(const Epoll & other);

/**
 * Operator overload= of 11-Poll class
 *
 * operator=(const 11-Poll&);
 *
 * @param   rhs instance const to copy the 11-Poll
 * @throw   none
 **/
    Epoll& operator=(const Epoll & rhs);

/**
 * Destructor of 11-Poll class
 *
 * 11-Poll();
 **/
    virtual ~Epoll();
 ...
 * before to add a epollEvent to 11-Poll
 *
...
/**
 * create an instance of 11-Poll in _epollInstance and
 * return a file descriptor to new instance of 11-Poll
 *
 * int createEpoll();
 *
...
/**
 * set Event instance with 11-Poll to add remove or modify
 *
 ...
 *
 * @returns void
 * @param   serverEvents table of 11-Poll event to store value
